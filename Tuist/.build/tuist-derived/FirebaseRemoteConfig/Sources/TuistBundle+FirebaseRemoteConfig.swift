...
/// Since FirebaseRemoteConfig is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Firebase_FirebaseRemoteConfig"
    ...
    fatalError("unable to find bundle named Firebase_FirebaseRemoteConfig")
}()
}
...
@objc
public class FirebaseRemoteConfigResources: NSObject {
