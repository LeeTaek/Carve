...
/// Since GoogleUtilitiesPrivacy is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "GoogleUtilities_GoogleUtilitiesPrivacy"
    ...
    fatalError("unable to find bundle named GoogleUtilities_GoogleUtilitiesPrivacy")
}()
}
...
@objc
public class GoogleUtilitiesPrivacyResources: NSObject {
