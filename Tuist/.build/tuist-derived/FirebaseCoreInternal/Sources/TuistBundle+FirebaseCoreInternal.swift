...
/// Since FirebaseCoreInternal is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Firebase_FirebaseCoreInternal"
    ...
    fatalError("unable to find bundle named Firebase_FirebaseCoreInternal")
}()
}
...
@objc
public class FirebaseCoreInternalResources: NSObject {
