...
> ✅ **D9-6 통과** (R23 · R24 수정 완료) · **D9-5-1 · D9-7-1 · D9-7-3 통과**(XCUITest 자동화) · **D9-5 나머지 · D9-7-2 · D9-CK③ ❓ 미수행** (§8-7).
>
...
> | **D9-5-1 · D9-7-1 · D9-7-3** | ✅ **통과** — XCUITest 실기기 자동화 (2026-09-09) |
> | **D9-5 나머지 · D9-7-2 · D9-CK③** | ❓ **미수행** — D9-5-2 는 자동화 불가(메뉴가 remote view), D9-7-2 는 Pencil 필요 |
>
...
| D9-5-2 | 올바른 절이 잡힘 | ❓ | ⛔ **자동화 대상에서 제외.** 메뉴가 remote view 라 조회로 못 누르고, 좌표로 누르면 PencilKit 메뉴와 구분되지 않는다 (아래 사고) |
| D9-5-3 | 본문 쪽 x 클램프 | | |
