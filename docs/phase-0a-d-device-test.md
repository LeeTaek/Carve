...
> · 회귀 기준선 **310** (설계 §19-4-2). **아래 기록에 남은 265 · 296 등은 그 시점의 이력이며 현재 기준선이 아닙니다.**
...
> ✅ **D9-6 통과** (R23 · R24 수정 완료) · **D9-5 통과**(5-1·5-2·5-6 확인, 5-4·5-5 는 대상 부재로 판정 불가) · **D9-7-1 · D9-7-3 통과** · ⚠️ **R25**(롱프레스 메뉴가 PencilKit 메뉴로 바뀜 — 데이터 위험) · **D9-7-2 · D9-CK③ ❓ 미수행** (§8-7).
>
...
| 회귀 기준선 | **310** (설계 §19-4-2) | ⚠️ 이 표가 작성될 당시(rev.5)는 265 였습니다. **줄어들면 회귀입니다** |
...
> | **D9-7-2 · D9-CK③** | ❓ **미수행** — D9-7-2 는 Pencil 필요 |
>
...
| 백업 (§2-4) | ❓ 미기록 |
| 실기기 빌드·설치·실행 | ✅ 성공 |
| 회귀 기준선 | **310** (설계 §19-4-2). ⚠️ 아래 기록에 남은 265 · 296 은 그 시점의 이력입니다 |
