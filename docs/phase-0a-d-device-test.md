...
> · 회귀 기준선 **308** (설계 §19-4-2). **아래 기록에 남은 265 · 296 등은 그 시점의 이력이며 현재 기준선이 아닙니다.**
...
> ✅ **D9-6 통과** (R23 · R24 수정 완료) · **D9-5 · D9-7 나머지 · D9-CK③ ❓ 미수행** (§8-7).
>
...
| 회귀 기준선 | **308** (설계 §19-4-2) | ⚠️ 이 표가 작성될 당시(rev.5)는 265 였습니다. **줄어들면 회귀입니다** |
...
| 백업 (§2-4) | ❓ 미기록 |
| 실기기 빌드·설치·실행 | ✅ 성공 |
| 회귀 기준선 | **308** (설계 §19-4-2). ⚠️ 아래 기록에 남은 265 · 296 은 그 시점의 이력입니다 |
