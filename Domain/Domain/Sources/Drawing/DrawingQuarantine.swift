...
public struct DrawingQuarantineItem: Equatable, Sendable {
    ...
    public init(chapter: BibleChapter, verse: Int, lineData: Data?, drawingVersion: Int?, layoutMetadataData: Data?) {
...
public protocol DrawingQuarantineClient: Sendable {
    ...
    /// - Parameter environment: 무효가 된 **세션의** 환경. 격리본은 만들 당시의 계정 범위 · K 를 든다.
...
public struct FileDrawingQuarantine: DrawingQuarantineClient {
    ...
    public func quarantine(_ items: [DrawingQuarantineItem], environment: DrawingEditEnvironment) async throws {
