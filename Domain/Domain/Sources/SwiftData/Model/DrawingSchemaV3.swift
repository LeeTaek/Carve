...
public enum DrawingSchemaV3Minor2: VersionedSchema {
    public static var versionIdentifier = Schema.Version(3, 2, 0)
    ...
    public final class BibleDrawing: Equatable {
        ...
        public var baseFirstUnderlineOffset: Double?
...
public typealias BibleDrawing = DrawingSchemaV3Minor2.BibleDrawing
public typealias BiblePageDrawing = DrawingSchemaV3Minor2.BiblePageDrawing
